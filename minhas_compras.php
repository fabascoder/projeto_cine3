...
<?php 
    ...
    <main>
        <div class="barra-lateral">
            <p>Olá <span style="color: #d95f80; text-decoration: underline;"><?php echo $_SESSION['nome'];?>,</span> Esse <br>é o seu Perfil</p>
